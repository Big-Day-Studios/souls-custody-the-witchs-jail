    ...
    render(){
        ...
        return(
            <div className= "all_game">
                ...
                <Typical
                steps={['Talvez eu consiga ajudar esse cara, que nem eu fiz com a Poppy!', 1000, ' Primeiro tenho que entender o que ele tá falando.', 1000]}
                loop={1}
                wrapper="p"
                className="texto"
                />
