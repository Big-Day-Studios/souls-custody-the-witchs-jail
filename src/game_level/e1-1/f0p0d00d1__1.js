    ...
    render(){
        ...
        return(
            <div className= "all_game">
                ...
                <Typical
                steps={['Por que alguém escreveria algo assim aqui?', 1300, 'Que lugar estranho.', 1300, 'Bom...', 700, 'Não achei nada de mais...', 1300, 'Melhor voltar e ver o que tinha atrás daquela porta.', 10]}
                loop={1}
                wrapper="p"
                className="texto"
                />
