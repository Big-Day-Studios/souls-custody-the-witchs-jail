...
export default class f0p0d032__1 extends React.Component{
    ...
    render(){
        ...
        return(
            <div className= "all_game">
                ...
                <Typical
                steps={['A mesma coisa que aconteceu com todo mundo aqui.', 1300, 'Ele tá amaldiçoado e implorando por ajuda.']}
                loop={1}
                wrapper="p"
                className="texto"
                />
