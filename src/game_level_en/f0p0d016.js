...
import en_f0p0d017 from "./f0p0d017";
            ...
            <div className= "all_game">
                ...
                <Link onClick={link} to="f0p0d017">
                    <div className="choice_0">
                        <p className="choice_0t">So can you help me find her?</p>
                    </div>
                </Link>
                <Link onClick={link} to="f0p0d017">
                    <div className="choice_1">
                        <p className="choice_1t">So, if you're free now, why don't you just get out of here?</p>
                    </div>
                </Link>
